...
from app.domain.entities.subscription import (
    SubscriptionCreate, SubscriptionResponse, SubscriptionPlan, SubscriptionPlanResponse
)
...
async def list_subscription_plans():
    ...
    return [
        ...
        SubscriptionPlanResponse(
            ...
            label="Yearly",
            description="Yearly subscription with full access",
            price_cents=9999,
            interval="year"
        ),
    ]
...
async def get_my_subscription(
    ...
    return await subscription_service.get_subscription_by_user_id(current_user.id)
